...
<div class="container mx-auto px-4">
  <div class="flex justify-between items-center py-4">
    ...
    <a href="{{ route('admin.create') }}" class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">
      Create Post
    </a>
  </div>
        ...
        @foreach($posts as $post)
          <tr class="border-b border-gray-700 hover:bg-gray-600">
            ...
            <td class="py-3 px-6 text-left">
              <a href="{{ route('admin.edit', $post->id) }}" class="bg-yellow-600 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded">
                Edit
              </a>
              <form action="{{ route('admin.destroy', $post->id) }}" method="POST" class="inline-block">
                @csrf
                @method('DELETE')
